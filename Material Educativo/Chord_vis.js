...
const CHORD_TYPES = [
  ...
  { suffixes:['test1'],
    label:'test1', intervals:[0,2]},

  { suffixes:['test2'],
    label:'test2', intervals:[0,6]},

  { suffixes:['test3'],
    label:'test3', intervals:[0,4]},

  { suffixes:['test4'],
    label:'test4', intervals:[0]},

  {suffixes:['bem'],
    label:'test5', intervals:[0,11]},
  
  { suffixes:['sos'],
    label:'test6', intervals:[0,1]},
  ...
  { suffixes:['aug','augmented','aumentado','+', 'aum'],
